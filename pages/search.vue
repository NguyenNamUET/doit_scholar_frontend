...
<!--&lt;!&ndash;        <AuthorCard&ndash;&gt;-->
<!--&lt;!&ndash;          v-for="(author, index) in authors_list"&ndash;&gt;-->
<!--&lt;!&ndash;          :key="index"&ndash;&gt;-->
<!--&lt;!&ndash;          v-bind:author_info="author"&ndash;&gt;-->
<!--&lt;!&ndash;        >&ndash;&gt;-->
<!--&lt;!&ndash;        </AuthorCard>&ndash;&gt;-->
<!--      </div>-->
    </div>
...
import SimpleDropdown from "@/components/search_page/SimpleDropdown";
      ...
      async asyncData({query, store, route}) {
        ...
        if(store.state.search_result.search_results.length > 0) {
          return {
            ...
            facet: store.state.search_result.aggregation
          }
        }
        else{
           return {
