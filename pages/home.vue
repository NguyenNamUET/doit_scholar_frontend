<template>
  <div class="container">
    <div class="tile is-ancestor">
      ...
      <div class="tile is-parent">
        <div class="tile is-child">
          <p class="content_title">Site status</p>
...
<!--        </div>-->
        <div class="tile is-child">
          <p class="content_title">Journals</p>
          <div class="content_box">
            <ul>
      ...
      <div class="tile is-parent is-vertical is-6">
        <div class="tile is-child">
          <p class="content_title">Latest papers</p>
          <SearchResult
        ...
        <div class="tile is-child">
          <p class="content_title">Most cited papers</p>
          <SearchResult
...
<!--        </div>-->
      ...
      <div class="tile">
        <div class="tile is-parent is-vertical">
          ...
          <div class="tile is-child">
            <p class="content_title">Fields of study</p>
            <div class="content_box">
              <ul>
